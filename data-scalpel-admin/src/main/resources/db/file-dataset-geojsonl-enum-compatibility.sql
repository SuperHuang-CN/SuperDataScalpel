-- GEOJSONL adds values to Java enums persisted as varchar columns.
-- Hibernate ddl-auto=update does not replace pre-existing enum CHECK constraints.
-- Run once after deploying GEOJSONL-capable binaries and before creating GEOJSONL datasets.
