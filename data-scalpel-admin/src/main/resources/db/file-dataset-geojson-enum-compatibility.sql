-- GeoJSON adds values to Java enums persisted as varchar columns.
-- Hibernate ddl-auto=update does not replace pre-existing enum CHECK constraints.
-- Run this script once after the application binaries are deployed and before creating GEOJSON datasets.
