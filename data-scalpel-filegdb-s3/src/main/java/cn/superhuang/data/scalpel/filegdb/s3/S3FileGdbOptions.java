...
/** Bounded block-cache settings for one open S3-backed File Geodatabase. */
public record S3FileGdbOptions(int blockSizeBytes, long maxCacheBytes) {
    ...
    public static S3FileGdbOptions defaults() {
        return new S3FileGdbOptions(DEFAULT_BLOCK_SIZE_BYTES, DEFAULT_MAX_CACHE_BYTES);
    }
}
