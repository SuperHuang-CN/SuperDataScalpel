...
@JsonClassDescription("仅支持 STREAMING 的 Canvas Stream-Static Join 节点；把左侧 UNBOUNDED 流与右侧 BOUNDED 静态表执行 INNER 或 LEFT 等值连接。当前没有 Stream-Stream Join 的时间范围和状态清理能力。")
