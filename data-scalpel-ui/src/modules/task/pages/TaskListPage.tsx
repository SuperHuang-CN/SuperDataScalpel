          ...
          try {
            if (drawerTask) {
              ...
              if (assistantCreate) {
                ...
                navigate(taskPageHref(`/task/${created.id}/definition`, `?taskView=${view}`, created.type), {
