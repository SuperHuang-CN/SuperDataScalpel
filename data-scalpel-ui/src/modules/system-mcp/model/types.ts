...
export interface Token { id: string; name: string; userId: string; username: string; enabled: boolean; revision: number; expiresAt?: string; lastUsedAt?: string; createdAt: string }
