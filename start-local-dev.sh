...
ENGINE_ACCESS_POLICY_JSON="${DATASCALPEL_START_ENGINE_ACCESS_POLICY_JSON:-}"
if [[ -z "$ENGINE_ACCESS_POLICY_JSON" ]]; then
  ENGINE_ACCESS_POLICY_JSON='{"allowCidrs":["127.0.0.1/32","::1/128"],"denyCidrs":[]}'
fi
