...
public final class CanvasNodeOperators {
    private static final CanvasNodeOperatorRegistry BUILT_IN_REGISTRY =
            new CanvasNodeOperatorRegistry(List.of(
                    ...
                    new GeometryDeriveNodeOperator(),
                    new GeometrySimplifyNodeOperator(),
                    new SpatialNearestNodeOperator(),
                    new SpatialSummarizeWithinNodeOperator(),
                    new SpatialOverlayNodeOperator(),
                    new TrackReconstructNodeOperator(),
                    new TrackMotionStatisticsNodeOperator(),
                    new TrackFindDwellNodeOperator(),
                    new TrackDetectIncidentsNodeOperator(),
                    new SpatialBinAggregateNodeOperator(),
                    new SpatialPointClusterNodeOperator(),
                    new SpatialCenterDispersionNodeOperator(),
                    new SpatialDensityNodeOperator(),
                    new SpatialHotSpotsNodeOperator(),
                    new SpatialMultiVariableGridNodeOperator(),
                new SpatialEnrichFromGridNodeOperator(),
                new SpatialGroupByProximityNodeOperator(),
                new TraceProximityEventsNodeOperator(),
                new SnapTracksNodeOperator(),
                new SpatialSimilarLocationsNodeOperator(),
                new SpatialDescribeDatasetNodeOperator(),
