...
public final class OpenGaussDialect extends AbstractJdbcDialect implements JdbcIncrementalReadDialect {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                ...
                if (!"r".equals(kind) && !"p".equals(kind) && !"m".equals(kind)) {
                    return TablePhysicalStatistics.unsupported("当前 openGauss 物理对象类型无法提供表统计");
                }
            ...
            if ("42P01".equals(exception.getSQLState()) || "42883".equals(exception.getSQLState())) {
                return TablePhysicalStatistics.unsupported("当前 openGauss 版本无法提供物理表快速统计");
            }
            throw exception;
        }
    }
