...
public final class FileGdbCoordinateSequence {
    private final double[] x;
    private final double[] y;
    private final double[] z;
    private final double[] m;

    public FileGdbCoordinateSequence(double[] x, double[] y, double[] z, double[] m) {
    ...
    public boolean equals(Object candidate) {
        ...
        if (!(candidate instanceof FileGdbCoordinateSequence other)) {
            return false;
        }
